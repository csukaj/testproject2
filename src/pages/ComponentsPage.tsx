...
import SInfiniteScrollDateRangePickerDemo from "../components/SInfiniteScrollDateRangePickerDemo";

const sComponents = [
    {url: '#', title: 'Infinite Scroll Date Range Picker', components: [<SInfiniteScrollDateRangePickerDemo/>]},
